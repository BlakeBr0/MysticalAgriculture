...
public class TileEntityInferiumFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public String getName(){
        return this.hasCustomName() ? this.furnaceCustomName : "container.mysticalagriculture:inferium_furnace.name";
    }
    ...
    public void update(){
        ...
        if (!this.worldObj.isRemote){
            ...
            if (flag != this.isBurning()){
                flag1 = true;
                BlockInferiumFurnace.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
        if (flag1){
            this.markDirty();
