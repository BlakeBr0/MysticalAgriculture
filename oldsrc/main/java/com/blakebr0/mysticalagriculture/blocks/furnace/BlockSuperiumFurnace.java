...
public class BlockSuperiumFurnace extends BlockContainer {
	
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    private final boolean isBurning;
    private static boolean keepInventory;

    public BlockSuperiumFurnace(boolean isBurning, String name, float hardness, float resistance, String tool, int level){
        super(Material.ROCK);
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List tooltip, boolean advanced){
		tooltip.add("Efficiency: \u00A7b+85%");
		super.addInformation(stack, player, tooltip, advanced);
	}

    @Nullable
    public Item getItemDropped(IBlockState state, Random rand, int fortune){
        return Item.getItemFromBlock(ModBlocks.superium_furnace);
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos){
        ...
        if(active){
            worldIn.setBlockState(pos, ModBlocks.superium_furnace_active.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.superium_furnace_active.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        } else {
            worldIn.setBlockState(pos, ModBlocks.superium_furnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.superium_furnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state){
        return new ItemStack(ModBlocks.superium_furnace);
    }
