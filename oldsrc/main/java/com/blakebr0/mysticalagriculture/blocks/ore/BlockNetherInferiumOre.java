...
public class BlockNetherInferiumOre extends Block {

	public BlockNetherInferiumOre(String name, Material material, SoundType sound, float hardness, float resistance, String tool, int level) {
		super(material);
