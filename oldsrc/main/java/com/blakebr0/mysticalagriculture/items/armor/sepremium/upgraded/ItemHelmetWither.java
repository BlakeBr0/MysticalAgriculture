...
public class ItemHelmetWither extends ItemSupremiumHelmet {

	public ItemHelmetWither(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
