...
public class ItemChestplateResistance extends ItemSupremiumChestplate {

	public ItemChestplateResistance(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
