...
public class ItemSupremiumLeggings extends ItemArmor {
	public ItemSupremiumLeggings(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List tooltip, boolean advanced){
		if(stack.getItem() == ModItems.supremium_leggings){
