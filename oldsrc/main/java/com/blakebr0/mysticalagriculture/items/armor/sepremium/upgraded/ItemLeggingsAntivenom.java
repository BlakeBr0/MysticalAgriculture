...
public class ItemLeggingsAntivenom extends ItemSupremiumLeggings {

	public ItemLeggingsAntivenom(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
