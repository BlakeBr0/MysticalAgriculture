...
public class ItemLeggingsFire extends ItemSupremiumLeggings {

	public ItemLeggingsFire(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
