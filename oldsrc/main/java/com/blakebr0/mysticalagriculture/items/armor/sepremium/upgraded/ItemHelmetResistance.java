...
public class ItemHelmetResistance extends ItemSupremiumHelmet {

	public ItemHelmetResistance(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
