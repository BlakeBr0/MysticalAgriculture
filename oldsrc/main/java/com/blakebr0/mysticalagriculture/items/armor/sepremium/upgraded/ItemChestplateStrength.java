...
public class ItemChestplateStrength extends ItemSupremiumChestplate {

	public ItemChestplateStrength(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
	...
	public void onArmorTick(World world, EntityPlayer entity, ItemStack itemStack){
		...
		if(entity instanceof EntityLivingBase){
			entity.addPotionEffect(new PotionEffect(MobEffects.STRENGTH, 5, 0, true, false));
		}
	}
