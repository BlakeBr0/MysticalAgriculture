...
public class ItemChestplateFire extends ItemSupremiumChestplate {

	public ItemChestplateFire(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
