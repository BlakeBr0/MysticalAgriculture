...
public class ItemPrudentiumChestplate extends ItemArmor {

	public ItemPrudentiumChestplate(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
