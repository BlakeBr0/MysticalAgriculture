...
public class ItemChestplateWither extends ItemSupremiumChestplate {

	public ItemChestplateWither(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List tooltip, boolean advanced){
		...
		tooltip.add("Charm Slot: \u00A7cWither Resistance");
		super.addInformation(stack, player, tooltip, advanced);
	}
	
	@Override
    public ItemStack getContainerItem(ItemStack itemstack){
        return new ItemStack(ModItems.charm_wither, 1, 0);
    }
