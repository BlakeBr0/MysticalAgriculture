...
public class ItemBootsAntivenom extends ItemSupremiumBoots {

	public ItemBootsAntivenom(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
