...
public class ItemHelmetNightvision extends ItemSupremiumHelmet {

	public ItemHelmetNightvision(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
    ...
    public ItemStack getContainerItem(ItemStack itemstack){
        return new ItemStack(ModItems.charm_nightvision, 1, 0);
    }
	...
	public void onArmorTick(World world, EntityPlayer entity, ItemStack itemStack){
		...
		if(entity instanceof EntityLivingBase){
			entity.addPotionEffect(new PotionEffect(MobEffects.NIGHT_VISION, 240, 0, true, false));
		}
	}
