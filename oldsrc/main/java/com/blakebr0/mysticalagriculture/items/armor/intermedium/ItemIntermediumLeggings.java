...
public class ItemIntermediumLeggings extends ItemArmor {

	public ItemIntermediumLeggings(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
