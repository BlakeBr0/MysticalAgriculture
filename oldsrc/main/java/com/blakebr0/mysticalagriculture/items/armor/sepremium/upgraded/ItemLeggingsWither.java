...
public class ItemLeggingsWither extends ItemSupremiumLeggings {

	public ItemLeggingsWither(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
