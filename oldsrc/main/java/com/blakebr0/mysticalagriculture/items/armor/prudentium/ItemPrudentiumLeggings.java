...
public class ItemPrudentiumLeggings extends ItemArmor {

	public ItemPrudentiumLeggings(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
