...
public class ItemIntermediumHelmet extends ItemArmor {

	public ItemIntermediumHelmet(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
