...
public class ItemLeggingsResistance extends ItemSupremiumLeggings {

	public ItemLeggingsResistance(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
