...
public class ItemChestplateAbsorption extends ItemSupremiumChestplate {

	public ItemChestplateAbsorption(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List tooltip, boolean advanced){
		...
		tooltip.add("Charm Slot: \u00A7cAbsorption");
		super.addInformation(stack, player, tooltip, advanced);
	}
	
	@Override
    public ItemStack getContainerItem(ItemStack itemstack){
        return new ItemStack(ModItems.charm_absorption, 1, 0);
    }
	...
	public void onArmorTick(World world, EntityPlayer entity, ItemStack itemStack){
		...
		if(entity instanceof EntityLivingBase && entity.getActivePotionEffect(MobEffects.ABSORPTION) == null){
			entity.addPotionEffect(new PotionEffect(MobEffects.ABSORPTION, 9600, 4, true, false));
		}
	}
