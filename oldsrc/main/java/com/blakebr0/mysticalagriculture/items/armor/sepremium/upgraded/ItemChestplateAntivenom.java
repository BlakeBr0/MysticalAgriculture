...
public class ItemChestplateAntivenom extends ItemSupremiumChestplate {

	public ItemChestplateAntivenom(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List tooltip, boolean advanced){
		...
		tooltip.add("Charm Slot: \u00A7cAntivenom");
		super.addInformation(stack, player, tooltip, advanced);
	}
	
	@Override
    public ItemStack getContainerItem(ItemStack itemstack){
        return new ItemStack(ModItems.charm_antivenom, 1, 0);
    }
