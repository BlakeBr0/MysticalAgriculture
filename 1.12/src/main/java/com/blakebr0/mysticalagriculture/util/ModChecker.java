...
public class ModChecker {
	...
	public static final boolean ALUMINUM = OreDictionary.getOres("ingotAluminum").size() > 0 || OreDictionary.getOres("ingotAluminium").size() > 0 || THERMAL_FOUNDATION || IMMERSIVE_ENGINEERING || GALACTICRAFT_CORE || TECH_REBORN || PIXELMON || SUBSTRATUM || BASE_METALS;
	public static final boolean COPPER = OreDictionary.getOres("ingotCopper").size() > 0 || THERMAL_FOUNDATION || IC2 || IMMERSIVE_ENGINEERING || FORESTRY || TECH_REBORN || MEKANISM || SUBSTRATUM || BASE_METALS;
	...
	public static final boolean TIN = OreDictionary.getOres("ingotTin").size() > 0 || THERMAL_FOUNDATION || IC2 || GALACTICRAFT_CORE || FORESTRY || TECH_REBORN || MEKANISM || SUBSTRATUM || BASE_METALS;
	...
	public static final boolean STEEL = OreDictionary.getOres("ingotSteel").size() > 0 || THERMAL_FOUNDATION || IC2 || IMMERSIVE_ENGINEERING || TECH_REBORN || MEKANISM || SUBSTRATUM || BASE_METALS || BIG_REACTORS;
	...
	public static final boolean TITANIUM = OreDictionary.getOres("ingotTitanium").size() > 0 || GALACTICRAFT_PLANETS || TECH_REBORN;
	...
	public static final boolean IRIDIUM = OreDictionary.getOres("ingotIridium").size() > 0 || THERMAL_FOUNDATION || TECH_REBORN;
