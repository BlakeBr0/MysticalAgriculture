...
public class ModEntities {
	...
	public static void init(){
		...
		EntityRegistry.registerModEntity(new ResourceLocation(MysticalAgriculture.MOD_ID, "supremium_arrow"), EntitySupremiumArrow.class, "supremium_arrow", 3, MysticalAgriculture.INSTANCE, 64, 1, true);
