...
// TODO: cleanup
public class BlockUltimateFurnace extends BlockContainer implements IEnableable
{
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing heldItem, float side, float hitX, float hitY)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityUltimateFurnace)
            {
                playerIn.displayGUIChest((TileEntityUltimateFurnace)tileentity);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityUltimateFurnace)
            {
                ((TileEntityUltimateFurnace)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        if (!keepInventory)
        {
            ...
            if (tileentity instanceof TileEntityUltimateFurnace)
            {
                InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityUltimateFurnace)tileentity);
	...
	public boolean isEnabled(){
		return ModConfig.confEssenceFurnaces && ModConfig.confUltimateFurnace;
	}
}