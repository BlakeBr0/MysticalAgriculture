...
public class ItemGear extends ItemMeta {
	...
	public void init(){
		...
		itemSupremiumToolCore = addItem(3, "supremium_tool_core", true, Utils.asList(Tooltips.CORE_REMOVAL));
		...
		itemSupremiumArmorCore = addItem(8, "supremium_armor_core", true, Utils.asList(Tooltips.CORE_REMOVAL));
		...
		itemSupremiumArrowHead = addItem(18, "supremium_arrow_head");
