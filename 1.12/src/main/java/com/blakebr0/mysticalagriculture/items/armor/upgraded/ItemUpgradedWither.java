...
public class ItemUpgradedWither extends ItemSupremiumArmor {

	public ItemUpgradedWither(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
	...
	public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, ITooltipFlag advanced){
		...
		tooltip.add(Tooltips.CHARM_SLOT + Colors.RED + Tooltips.WITHER_RESISTANCE);
	}
	
	@Override
    public ItemStack getContainerItem(ItemStack itemstack){
        return new ItemStack(ModItems.itemCharmWither, 1, 0);
    }
