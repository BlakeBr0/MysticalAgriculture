mods.mysticalagriculture.InfusionCrafting.addRecipe("netherite_from_dirt", <item:minecraft:netherite_ingot>, [
    <item:minecraft:diamond>, <item:minecraft:air>, <item:minecraft:dirt>, <item:minecraft:air>, <item:minecraft:dirt>, <item:minecraft:air>, <item:minecraft:dirt>, <item:minecraft:air>, <item:minecraft:dirt>
]);
