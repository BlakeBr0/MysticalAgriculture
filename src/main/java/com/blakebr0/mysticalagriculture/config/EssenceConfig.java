...
public class EssenceConfig {
	...
	public static void syncConfig(){
		...
		tallGrass = config.get(category, "grass", 16).getInt();
		...
		category = "PneumaticCraft";
		compressedIron = config.get(category, "compressed_iron", 6).getInt();
