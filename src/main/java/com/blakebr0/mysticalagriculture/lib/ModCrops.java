...
public final class ModCrops {
    ...
    public static final Crop STONE = new Crop(new ResourceLocation(MOD_ID, "stone"), CropTier.ONE, CropType.RESOURCE, CropTextures.ROCK_CROP_TEXTURES, 0x7F7F7F, LazyIngredient.tag("forge:stone"));
    ...
    public static final Crop NETHER = new Crop(new ResourceLocation(MOD_ID, "nether"), CropTier.TWO, CropType.RESOURCE, CropTextures.ROCK_CROP_TEXTURES, 0x723232, LazyIngredient.item("mysticalagriculture:nether_agglomeratio"));
    ...
    public static final Crop OBSIDIAN = new Crop(new ResourceLocation(MOD_ID, "obsidian"), CropTier.THREE, CropType.RESOURCE, CropTextures.ROCK_CROP_TEXTURES, 0x271E3D, LazyIngredient.item("minecraft:obsidian"));
    ...
    public static final Crop END = new Crop(new ResourceLocation(MOD_ID, "end"), CropTier.FOUR, CropType.RESOURCE, CropTextures.ROCK_CROP_TEXTURES, 0xEEF6B4, LazyIngredient.item("mysticalagriculture:end_agglomeratio"));
    ...
    public static final Crop SULFUR = new Crop(new ResourceLocation(MOD_ID, "sulfur"), CropTier.TWO, CropType.RESOURCE, CropTextures.DUST_CROP_TEXTURES, 0xFDDC4B, LazyIngredient.tag("forge:dusts/sulfur"));
    ...
    public static final Crop COPPER = new Crop(new ResourceLocation(MOD_ID, "copper"), CropTier.TWO, CropType.RESOURCE, CropTextures.INGOT_CROP_TEXTURES, 0xF48702, LazyIngredient.tag("forge:ingots/copper"));
    public static final Crop SALTPETER = new Crop(new ResourceLocation(MOD_ID, "saltpeter"), CropTier.TWO, CropType.RESOURCE, CropTextures.DUST_CROP_TEXTURES, 0xC9BEBD, LazyIngredient.tag("forge:dusts/saltpeter"));
    public static final Crop TIN = new Crop(new ResourceLocation(MOD_ID, "tin"), CropTier.THREE, CropType.RESOURCE, CropTextures.INGOT_CROP_TEXTURES, 0x9ABDD6, LazyIngredient.tag("forge:ingots/tin"));
    public static final Crop BRONZE = new Crop(new ResourceLocation(MOD_ID, "bronze"), CropTier.THREE, CropType.RESOURCE, CropTextures.INGOT_CROP_TEXTURES, 0xC98C52, LazyIngredient.tag("forge:ingots/bronze"));
    ...
    public static final Crop SILVER = new Crop(new ResourceLocation(MOD_ID, "silver"), CropTier.THREE, CropType.RESOURCE, CropTextures.INGOT_CROP_TEXTURES, 0xA9DBE5, LazyIngredient.tag("forge:ingots/silver"));
    public static final Crop LEAD = new Crop(new ResourceLocation(MOD_ID, "lead"), CropTier.THREE, CropType.RESOURCE, CropTextures.INGOT_CROP_TEXTURES, 0x677193, LazyIngredient.tag("forge:ingots/lead"));
    ...
    public static final Crop NICKEL = new Crop(new ResourceLocation(MOD_ID, "nickel"), CropTier.FOUR, CropType.RESOURCE, CropTextures.INGOT_CROP_TEXTURES, 0xD8CC93, LazyIngredient.tag("forge:ingots/nickel"));
    public static final Crop CONSTANTAN = new Crop(new ResourceLocation(MOD_ID, "constantan"), CropTier.FOUR, CropType.RESOURCE, CropTextures.INGOT_CROP_TEXTURES, 0xD6A04A, LazyIngredient.tag("forge:ingots/constantan"));
    public static final Crop ELECTRUM = new Crop(new ResourceLocation(MOD_ID, "electrum"), CropTier.FOUR, CropType.RESOURCE, CropTextures.INGOT_CROP_TEXTURES, 0xD5BB4F, LazyIngredient.tag("forge:ingots/electrum"));
    public static final Crop INVAR = new Crop(new ResourceLocation(MOD_ID, "invar"), CropTier.FOUR, CropType.RESOURCE, CropTextures.INGOT_CROP_TEXTURES, 0xADB7B2, LazyIngredient.tag("forge:ingots/invar"));
    ...
    public static final Crop PLATINUM = new Crop(new ResourceLocation(MOD_ID, "platinum"), CropTier.FIVE, CropType.RESOURCE, CropTextures.INGOT_CROP_TEXTURES, 0x6FEAEF, LazyIngredient.tag("forge:ingots/platinum"));
