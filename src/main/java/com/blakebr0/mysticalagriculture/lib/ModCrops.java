...
public final class ModCrops {
    ...
    public static final Crop INFERIUM = new Crop(new ResourceLocation(MOD_ID, "inferium"), CropTier.ONE, CropType.RESOURCE, LazyIngredient.item("mysticalagriculture:inferium"));
    ...
    public static final Crop ALUMINUM = new Crop(new ResourceLocation(MOD_ID, "aluminum"), CropTier.TWO, CropType.RESOURCE, LazyIngredient.tag("forge:ingots/aluminum"));
    ...
    public static final Crop ZINC = new Crop(new ResourceLocation(MOD_ID, "zinc"), CropTier.THREE, CropType.RESOURCE, LazyIngredient.tag("forge:ingots/zinc"));
    public static final Crop BRASS = new Crop(new ResourceLocation(MOD_ID, "brass"), CropTier.THREE, CropType.RESOURCE, LazyIngredient.tag("forge:ingots/brass"));
    ...
    public static final Crop GRAPHITE = new Crop(new ResourceLocation(MOD_ID, "graphite"), CropTier.THREE, CropType.RESOURCE, LazyIngredient.tag("forge:ingots/graphite"));
    public static final Crop STEEL = new Crop(new ResourceLocation(MOD_ID, "steel"), CropTier.FOUR, CropType.RESOURCE, LazyIngredient.tag("forge:ingots/steel"));
    ...
    // INTEGRATED DYNAMICS
    public static final Crop MENRIL = new Crop(new ResourceLocation(MOD_ID, "menril"), CropTier.TWO, CropType.RESOURCE, LazyIngredient.item("integrateddynamics:menril_berries"));
