...
public class Tooltips {
	...
	public static final String SEMICOLON = Colors.GRAY + ": ";
	...
	public static final String SPEED = Colors.GREEN + Utils.localize(MobEffects.SPEED.getName()) + " II";
	public static final String RESISTANCE = Colors.GOLD + Utils.localize(MobEffects.RESISTANCE.getName()) + " II";
	public static final String REGENERATION = Colors.AQUA + Utils.localize(MobEffects.REGENERATION.getName()) + " II";
	public static final String STRENGTH = Colors.RED + Utils.localize(MobEffects.STRENGTH.getName()) + " II";
	
	public static final String BLINDNESS = Colors.YELLOW + Utils.localize(MobEffects.BLINDNESS.getName());
	public static final String SLOWNESS = Colors.GREEN + Utils.localize(MobEffects.SLOWNESS.getName());
	public static final String POISON = Colors.GOLD + Utils.localize(MobEffects.POISON.getName());
	public static final String WEAKNESS = Colors.AQUA + Utils.localize(MobEffects.WEAKNESS.getName());
	public static final String WITHER = Colors.RED + Utils.localize(MobEffects.WITHER.getName());
