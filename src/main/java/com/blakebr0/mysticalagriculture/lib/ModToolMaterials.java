...
public class ModToolMaterials {
    ...
    public static final ToolMaterial SUPERIUM = EnumHelper.addToolMaterial("SUPERIUM", 4, 4000, 19.0F, 11.0F, 35);
    ...
    public static final ArmorMaterial SUPERIUM_ARMOR = EnumHelper.addArmorMaterial("SUPERIUMARMOR", MysticalAgriculture.MOD_ID + ":" + "superium_armor", 160,
