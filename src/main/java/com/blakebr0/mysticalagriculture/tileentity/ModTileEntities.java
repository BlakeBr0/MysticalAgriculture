...
public class ModTileEntities {
    ...
    public static final TileEntityType<IntermediumFurnaceTileEntity> INTERMEDIUM_FURNACE = TileEntityType.Builder.create(IntermediumFurnaceTileEntity::new, ModBlocks.INTERMEDIUM_FURNACE).build(null);
    ...
    public void onRegisterTypes(RegistryEvent.Register<TileEntityType<?>> event) {
        ...
        registry.register(INTERMEDIUM_FURNACE.setRegistryName("intermedium_furnace"));
