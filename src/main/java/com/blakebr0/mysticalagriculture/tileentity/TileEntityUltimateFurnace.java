...
public class TileEntityUltimateFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public static void registerFixesFurnace(DataFixer fixer){
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityUltimateFurnace.class, new String[] {"Items"}));
    }
    ...
    public void update(){
        ...
        if(!this.world.isRemote){
            ...
            if(flag != this.isBurning()){
                flag1 = true;
                BlockUltimateFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
