...
public class ItemUpgradedStrength extends ItemSupremiumArmor {

	public ItemUpgradedStrength(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
