...
public class ItemHelmetAbsorption extends ItemSupremiumHelmet {

	public ItemHelmetAbsorption(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
