...
public class ItemLeggingsAbsorption extends ItemSupremiumLeggings {

	public ItemLeggingsAbsorption(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
