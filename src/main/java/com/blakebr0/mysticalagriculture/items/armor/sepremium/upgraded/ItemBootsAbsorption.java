...
public class ItemBootsAbsorption extends ItemSupremiumBoots {

	public ItemBootsAbsorption(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
