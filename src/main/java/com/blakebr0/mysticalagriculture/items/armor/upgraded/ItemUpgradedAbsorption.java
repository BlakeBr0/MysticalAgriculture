...
public class ItemUpgradedAbsorption extends ItemSupremiumArmor {

	public ItemUpgradedAbsorption(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
