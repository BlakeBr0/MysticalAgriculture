...
public class ItemLeggingsSpeed extends ItemSupremiumLeggings {

	public ItemLeggingsSpeed(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
	...
	public void onArmorTick(World world, EntityPlayer entity, ItemStack itemStack){
		...
		if(entity instanceof EntityLivingBase){
			entity.addPotionEffect(new PotionEffect(MobEffects.SPEED, 5, 3, true, false));
		}
	}
