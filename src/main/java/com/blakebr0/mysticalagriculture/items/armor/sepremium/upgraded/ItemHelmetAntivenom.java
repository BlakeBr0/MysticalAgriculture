...
public class ItemHelmetAntivenom extends ItemSupremiumHelmet {

	public ItemHelmetAntivenom(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
