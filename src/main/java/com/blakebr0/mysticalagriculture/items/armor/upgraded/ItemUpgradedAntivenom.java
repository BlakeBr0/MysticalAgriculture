...
public class ItemUpgradedAntivenom extends ItemSupremiumArmor {

	public ItemUpgradedAntivenom(String name, ArmorMaterial material, int index, EntityEquipmentSlot slot){
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List tooltip, boolean advanced){
		...
		tooltip.add(Tooltips.CHARM_SLOT + Colors.RED + Tooltips.ANTIVENOM);
	}
	
	@Override
    public ItemStack getContainerItem(ItemStack itemstack){
        return new ItemStack(ModItems.itemCharmAntivenom, 1, 0);
    }
