...
public class ModRecipes {
	...
	public static void initRecipes(){
	    ...
	    if(ModConfig.confWateringCans){
	    	addShapedRecipe(ItemCrafting.itemTheoreticalWater, "NEN", "EEE", "NEN", 'N', ItemNugget.itemBaseEssenceNugget, 'E', new ItemStack(type.WATER.getCrop(), 1, 0));
	    ...
	    if(ModConfig.confGearModuleOverride){
			...
			if(ModConfig.confAOECharms){
				...
				addTinkeringRecipe(new ItemStack(ModItems.itemSupremiumShovelAOE), new ItemStack(ModItems.itemSupremiumShovel, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ModItems.itemCharmMiningAOE, 1, 0));
			...
			if(ModConfig.confAOECharms){
				...
				addCharmRecipe(new ItemStack(ModItems.itemSupremiumHoe), new ItemStack(ModItems.itemSupremiumHoeAOE, 1, OreDictionary.WILDCARD_VALUE));
			}
