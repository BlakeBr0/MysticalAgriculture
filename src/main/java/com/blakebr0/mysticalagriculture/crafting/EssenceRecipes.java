...
public class EssenceRecipes {
	...
	public static void addEssenceRecipe(String output, int amount, Object... input) {
		if (amount > 0 && validate(input)) {
			ForgeRegistries.RECIPES.register(new ShapedOreOutputRecipe(output, amount, input).setMirrored(false).setRegistryName(RecipeHelper.getRecipeLocation(output)));
		}
	}
	...
	public static void init() {
	    ...
	    addEssenceRecipe(new ItemStack(Blocks.TALLGRASS, EssenceConfig.tallGrass, 1), "  E", "  E", " E ", 'E', new ItemStack(type.NATURE.getCrop(), 1, 0));
	    ...
	    if(type.HOP_GRAPHITE.isEnabled()){ addEssenceRecipe("ingotHOPGraphite", EssenceConfig.hopGraphite, "EEE", "E E", "EEE", 'E', new ItemStack(type.HOP_GRAPHITE.getCrop(), 1, 0)); }
	    ...
	    if(type.MARBLE.isEnabled() && ModChecker.CHISEL){ addEssenceRecipe(new ItemStack(Parts.itemChiselMarble, EssenceConfig.marble, 7), "EEE", "E E", "EEE", 'E', new ItemStack(type.MARBLE.getCrop(), 1, 0)); }
	    ...
	    if(type.ALUMITE.isEnabled()){ addEssenceRecipe("ingotAlumite", EssenceConfig.alumite, "EEE", "E E", "EEE", 'E', new ItemStack(type.ALUMITE.getCrop(), 1, 0)); }
	    ...
	    if(type.THORIUM.isEnabled()){ addEssenceRecipe("ingotThorium", EssenceConfig.thorium, "EEE", "E E", "EEE", 'E', new ItemStack(type.THORIUM.getCrop(), 1, 0)); }
	    if(type.BORON.isEnabled()){ addEssenceRecipe("ingotBoron", EssenceConfig.boron, "EEE", "E E", "EEE", 'E', new ItemStack(type.BORON.getCrop(), 1, 0)); }
	    if(type.LITHIUM.isEnabled()){ addEssenceRecipe("ingotLithium", EssenceConfig.lithium, "EEE", "E E", "EEE", 'E', new ItemStack(type.LITHIUM.getCrop(), 1, 0)); }
	    if(type.MAGNESIUM.isEnabled()){ addEssenceRecipe("ingotMagnesium", EssenceConfig.magnesium, "EEE", "E E", "EEE", 'E', new ItemStack(type.MAGNESIUM.getCrop(), 1, 0)); }
	    ...
	    if(type.MENRIL.isEnabled()){ addEssenceRecipe(new ItemStack(Parts.itemIDMenrilSapling, EssenceConfig.menrilSapling, 0), "EFE", "   ", "   ", 'E', new ItemStack(type.MENRIL.getCrop(), 1, 0), 'F', new ItemStack(type.NATURE.getCrop(), 1, 0)); }
	    if(type.MENRIL.isEnabled()){ addEssenceRecipe(new ItemStack(Parts.itemIDMenrilBerry, EssenceConfig.menrilBerry, 0), "E  ", " E ", "  E", 'E', new ItemStack(type.MENRIL.getCrop(), 1, 0)); }
