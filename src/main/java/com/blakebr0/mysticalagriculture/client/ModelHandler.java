...
//        Function<ResourceLocation, TextureAtlasSprite> getSprite = Minecraft.getInstance().getTextureManager()::getSprite;
...
//                                }
//                                IBakedModel cropBakedModel = cropRetexturedModel.bake(bakery, getSprite, ModelRotation.X0_Y0, DefaultVertexFormats.BLOCK);
//
...
//        });
    ...
    public void onTextureStitch(TextureStitchEvent.Pre event) {
        if (event.getMap().getId().getPath().equals("block")) {
