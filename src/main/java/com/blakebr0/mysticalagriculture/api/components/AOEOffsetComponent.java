...
public record AOEOffsetComponent(int horizontalOffset, int verticalOffset) {
    public static final AOEOffsetComponent DEFAULT = new AOEOffsetComponent(0, 0);
    public static final MapCodec<AOEOffsetComponent> MAP_CODEC = RecordCodecBuilder.mapCodec(builder ->
        builder.group(
            Codec.INT.fieldOf("horizontal_offset").forGetter(AOEOffsetComponent::horizontalOffset),
            Codec.INT.fieldOf("vertical_offset").forGetter(AOEOffsetComponent::verticalOffset)
