...
public final class MysticalAgricultureDataComponentTypes {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<AOEOffsetComponent>> AOE_OFFSET = DeferredHolder.create(Registries.DATA_COMPONENT_TYPE, MysticalAgricultureAPI.resource("aoe_offset"));
}
