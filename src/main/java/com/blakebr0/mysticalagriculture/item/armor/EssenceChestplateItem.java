...
public class EssenceChestplateItem extends ArmorItem implements ITinkerable {
    ...
    public EssenceChestplateItem(IArmorMaterial material, int tinkerableTier, int slots, Function<Properties, Properties> properties) {
