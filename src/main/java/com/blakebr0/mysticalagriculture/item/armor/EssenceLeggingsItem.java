...
public class EssenceLeggingsItem extends ArmorItem implements ITinkerable {
    ...
    public EssenceLeggingsItem(IArmorMaterial material, int tinkerableTier, int slots, Function<Properties, Properties> properties) {
