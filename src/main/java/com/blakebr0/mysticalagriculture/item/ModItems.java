...
public class ModItems {
    ...
    public static final RegistryObject<EssenceWateringCanItem> INFERIUM_WATERING_CAN = registerGear("inferium_watering_can", () -> new EssenceWateringCanItem(3, CropTier.ONE.getTextColor(), p -> p.group(ITEM_GROUP)));
    ...
    public static final RegistryObject<EssenceWateringCanItem> PRUDENTIUM_WATERING_CAN = registerGear("prudentium_watering_can", () -> new EssenceWateringCanItem(5, CropTier.TWO.getTextColor(), p -> p.group(ITEM_GROUP)));
    ...
    public static final RegistryObject<EssenceWateringCanItem> TERTIUM_WATERING_CAN = registerGear("tertium_watering_can", () -> new EssenceWateringCanItem(7, CropTier.THREE.getTextColor(), p -> p.group(ITEM_GROUP)));
    ...
    public static final RegistryObject<EssenceWateringCanItem> IMPERIUM_WATERING_CAN = registerGear("imperium_watering_can", () -> new EssenceWateringCanItem(9, CropTier.FOUR.getTextColor(), p -> p.group(ITEM_GROUP)));
    ...
    public static final RegistryObject<EssenceWateringCanItem> SUPREMIUM_WATERING_CAN = registerGear("supremium_watering_can", () -> new EssenceWateringCanItem(11, CropTier.FIVE.getTextColor(), p -> p.group(ITEM_GROUP)));
