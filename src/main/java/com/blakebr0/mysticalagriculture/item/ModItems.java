...
public class ModItems {
    ...
    public static final EssenceStaffItem INTERMEDIUM_STAFF = new EssenceStaffItem(p -> p.group(ITEM_GROUP));
    ...
    public void onRegisterItems(RegistryEvent.Register<Item> event) {
        ...
        registry.register(INTERMEDIUM_STAFF.setRegistryName("intermedium_staff"));
