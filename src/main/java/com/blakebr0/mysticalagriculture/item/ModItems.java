...
public class ModItems {
    ...
    public static final EssenceSwordItem TERTIUM_SWORD = new EssenceSwordItem(ModItemTier.TERTIUM, 3, -2.4F, p -> p.group(ITEM_GROUP));
    public static final EssencePickaxeItem TERTIUM_PICKAXE = new EssencePickaxeItem(ModItemTier.TERTIUM, 1, -2.8F, p -> p.group(ITEM_GROUP));
    public static final EssenceShovelItem TERTIUM_SHOVEL = new EssenceShovelItem(ModItemTier.TERTIUM, 1.5F, -3.0F, p -> p.group(ITEM_GROUP));
    public static final EssenceAxeItem TERTIUM_AXE = new EssenceAxeItem(ModItemTier.TERTIUM, 5.0F, -3.0F, p -> p.group(ITEM_GROUP));
    public static final EssenceHoeItem TERTIUM_HOE = new EssenceHoeItem(ModItemTier.TERTIUM, 0.0F, p -> p.group(ITEM_GROUP));
