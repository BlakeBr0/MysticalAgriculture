...
public class BlockEssenceReprocessor extends BlockContainer implements IEnableable {
    ...
    public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) {
    	...
    	if (!Utils.isShiftKeyDown()) {
    		...
    		tooltip.add(Utils.localize("tooltip.ma.reprocessor_speed"));
    		tooltip.add(Utils.localize("tooltip.ma.reprocessor_fuel_rate"));
    		tooltip.add(Utils.localize("tooltip.ma.reprocessor_fuel_capacity"));
    	}
    }
