...
public class BlockTier4InferiumCrop extends BlockCrops implements IHornHarvestable {

    private static final AxisAlignedBB CROPS_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.25D, 1.0D);

    public BlockTier4InferiumCrop(String name) {
    	super();
    ...
    protected Item getSeed(){
    	return ModItems.itemTier4InferiumSeeds;
    }
