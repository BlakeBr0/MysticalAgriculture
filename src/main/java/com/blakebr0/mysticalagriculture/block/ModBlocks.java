...
public class ModBlocks {
    ...
    public static final BaseBlock TERTIUM_BLOCK = new BaseBlock(Material.ROCK, SoundType.STONE, 4.0F, 6.0F);
    ...
    public static final BaseBlock TERTIUM_INGOT_BLOCK = new BaseBlock(Material.IRON, SoundType.METAL, 5.0F, 6.0F);
    ...
    public static final BaseBlock TERTIUM_GEMSTONE_BLOCK = new BaseBlock(Material.IRON, SoundType.METAL, 5.0F, 6.0F);
    ...
    public static final EssenceFurnaceBlock IMPERIUM_FURNACE = new EssenceFurnaceBlock(EssenceFurnaceBlock.FurnaceTier.IMPERIUM);
    public static final EssenceFurnaceBlock SUPREMIUM_FURNACE = new EssenceFurnaceBlock(EssenceFurnaceBlock.FurnaceTier.SUPREMIUM);
    ...
    public void onRegisterBlocks(RegistryEvent.Register<Block> event) {
        ...
        register(registry, TERTIUM_BLOCK.setRegistryName("tertium_block"));
        ...
        register(registry, TERTIUM_INGOT_BLOCK.setRegistryName("tertium_ingot_block"));
        ...
        register(registry, TERTIUM_GEMSTONE_BLOCK.setRegistryName("tertium_gemstone_block"));
        ...
        register(registry, TERTIUM_FARMLAND.setRegistryName("tertium_farmland"));
        ...
        register(registry, TERTIUM_GROWTH_ACCELERATOR.setRegistryName("tertium_growth_accelerator"));
        ...
        register(registry, TERTIUM_FURNACE.setRegistryName("tertium_furnace"));
